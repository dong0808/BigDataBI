...
<script type="text/javascript">
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{
            ...
            {text:'地区基本信息查询',
                items:[
                    {id:'121',text:'合肥',href:"/content/queryPage/query_hefei.html"},
                    {id:'122',text:'蚌埠',href:"/content/queryPage/query_bengbu.html"},
                    {id:'123',text:'芜湖',href:"/content/queryPage/query_wuhu.html"},
                    {id:'124',text:'淮南',href:"/content/queryPage/query_huainan.html"},
                    {id:'125',text:'六安',href:"/content/queryPage/query_luan.html"},
                    {id:'126',text:'宿州',href:"/content/queryPage/query_suzhou.html"},
                    {id:'127',text:'亳州',href:"/content/queryPage/query_hefei.html"},
                    {id:'128',text:'阜阳',href:"/content/queryPage/query_hefei.html"},
                    {id:'129',text:'安庆',href:"/content/queryPage/query_hefei.html"},
                    {id:'1210',text:'淮北',href:"/content/queryPage/query_hefei.html"},
                    {id:'1211',text:'黄山',href:"/content/queryPage/query_hefei.html"},
                    {id:'1212',text:'滁州',href:"/content/queryPage/query_hefei.html"},
                    {id:'1213',text:'巢湖',href:"/content/queryPage/query_hefei.html"},
                    {id:'1214',text:'马鞍山',href:"/content/queryPage/query_hefei.html"},
                    {id:'1215',text:'铜陵',href:"/content/queryPage/query_hefei.html"},
                    {id:'1216',text:'宣城',href:"/content/queryPage/query_hefei.html"},
                ]},
           {text:'气象数据查询',
            items:[
