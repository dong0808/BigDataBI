...
<div class="row" align="center">
    <div class="span24">
        <div class="panel-header"><h3 align="center"><font color="#6495ed">CO指标查询</font></h3></div>
        ...
        $("#btnSearch1").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    var d = eval(data);
                    console.log(d);
                    mychart(d[0].dateResult,d[0].coResult,d[0].stationName);
                },
                error:function () {
                    alert("出错了的！！");
                }
